...
export default function AdminQuestionManager({ onBack }) {
  ...
  return <div className="admin-page">
    ...
    <div className="admin-shell">
      <header className="admin-head"><div><small>SECURE OWNER TOOL</small><h1>Admin Question Manager</h1></div><button className="admin-back" onClick={onBack}>← Dashboard</button></header>
